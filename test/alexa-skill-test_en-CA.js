...
describe('Awesome Quotations Skill (en-CA)', () => {
    ...
    describe('AuthorQuoteIntent', () => {
        alexaTest.test([
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'hemingway' }),
                saysLike: "Here's your quotation from Ernest Hemingway: ",
                hasCardTitle: 'Ernest Hemingway',
                //TODO hasCardTextLike: 'Zitat',
                repromptsNothing: true, shouldEndSession: true,
            },
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'shakespeare' }),
                saysLike: "Here's your quotation from William Shakespeare: ",
                hasCardTitle: 'William Shakespeare',
                //TODO hasCardTextLike: 'Zitat',
                repromptsNothing: true, shouldEndSession: true,
            },
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'leonard cohen' }),
                saysLike: "Here's your quotation from Leonard Cohen: ",
                hasCardTitle: 'Leonard Cohen',
                //TODO hasCardTextLike: 'Zitat',
                repromptsNothing: true, shouldEndSession: true,
            },
            {
