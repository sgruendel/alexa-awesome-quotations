...
describe('Awesome Quotations Skill (en-GB)', () => {
    ...
    describe('AuthorQuoteIntent', () => {
        alexaTest.test([
            ...
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'churchill' }),
                saysLike: "Here's your quotation from Winston Churchill: ",
                hasCardTitle: 'Winston Churchill',
                //TODO hasCardTextLike: 'Zitat',
                repromptsNothing: true, shouldEndSession: true,
            },
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'jk rowling' }),
                saysLike: "Here's your quotation from J. K. Rowling: ",
