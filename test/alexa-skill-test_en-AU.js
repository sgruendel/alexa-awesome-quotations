...
describe('Awesome Quotations Skill (en-AU)', () => {
    ...
    describe('AuthorQuoteIntent', () => {
        alexaTest.test([
            {
                request: alexaTest.getIntentRequest('AuthorQuoteIntent', { Author: 'heath ledger' }),
                saysLike: "Here's your quotation from Heath Ledger: ",
                hasCardTitle: 'Heath Ledger',
                //TODO hasCardTextLike: 'Zitat',
                repromptsNothing: true, shouldEndSession: true,
            },
            {
