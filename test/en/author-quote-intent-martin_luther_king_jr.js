...
describe('Testing a session with the AuthorQuoteIntent:', () => {
            ...
            "request": {
                ...
                "intent": {
                    ...
                    "slots": {
                        "Author": {
                            "name": "Author",
                            "value": "martin luther king junior"
                        }
                    }
                }
            },
    ...
    describe('The response', () => {
        ...
        it('should have a card title for Martin Luther King, Jr.', () => {
            expect(speechResponse.response.card.title).to.equal('Martin Luther King, Jr.')
        })
